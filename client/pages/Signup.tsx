...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate("/detection"); // Redirect to detection page after successful signup
    } catch (error: any) {
          ...
          <div className="glass p-8 border border-white/20 rounded-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-foreground/60 mt-2">
                Join Secure Sphere to protect your platform
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-neon-cyan w-5 h-5" />
                  <input
                    id="fullName"
                    name="fullName"
                    type="text"
              ...
              <div>
                ...
                <div className="relative">
                  <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-neon-cyan w-5 h-5" />
                  <input
                    id="phone"
                    name="phone"
                    type="tel"
